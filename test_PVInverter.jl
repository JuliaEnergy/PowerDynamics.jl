...
node_list=[]
    ...
    append!(node_list,[PVInverterWithFrequencyControl(I_n=1.,k_PLL=1.,f=50,f_s=50.05,T_m=0.1,k_P=0.2,τ_ω=1.)])
    line_list=[]
...
result = simulate(Perturbation(1, :ω, Inc(0.1)), powergrid, operationpoint, timespan = (0.0,3.))
#result = simulate(PowerPerturbation(1,0.9,(0.1,0.3)),powergrid, operationpoint, timespan = (0.0,3.))
