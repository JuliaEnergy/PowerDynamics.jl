...
@testset "WindGenType 4 with Rotor Control Tests" begin
    ...
    @syms T_L T_H K_P K_PLL C J u_dcref K_Q K_v K_g1 K_g2 K_r1 K_r2 positive=true
    ...
    @test_throws AssertionError construct_vertex(WindTurbineGenType4_RotorControl(T_L=T_L,T_H=T_H,K_P=K_P,K_PLL=k_PLL_INVALID,Q_ref=Q_ref,C=C,J=J,P=P,ω_rref=ω_rref,u_dcref=u_dcref,K_Q=K_Q,K_v=K_v,K_g1=K_g1,K_g2=K_g2,K_r1=K_r1,K_r2=K_r2))
    @test_throws AssertionError construct_vertex(WindTurbineGenType4_RotorControl(T_L=T_L,T_H=T_H,K_P=k_P_invalid,K_PLL=K_PLL,Q_ref=Q_ref,C=C,J=J,P=P,ω_rref=ω_rref,u_dcref=u_dcref,K_Q=K_Q,K_v=K_v,K_g1=K_g1,K_g2=K_g2,K_r1=K_r1,K_r2=K_r2))

    wind_gen = WindTurbineGenType4_RotorControl(T_L=T_L,T_H=T_H,K_P=K_P,K_PLL=K_PLL,Q_ref=Q_ref,C=C,J=J,P=P,ω_rref=ω_rref,u_dcref=u_dcref,K_Q=K_Q,K_v=K_v,K_g1=K_g1,K_g2=K_g2,K_r1=K_r1,K_r2=K_r2)
