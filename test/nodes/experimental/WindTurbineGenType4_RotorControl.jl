...
@testset "WindGenType 4 with Rotor Control Tests" begin
    ...
    @test_throws AssertionError construct_vertex(WindTurbineGenType4(T_L=T_L,T_H=T_H,K_P=K_P,ΔP_max=ΔP_max,K_PLL=k_PLL_INVALID,C=C,J=J,u_dcref=u_dcref,K_Q=K_Q,K_v=K_v,K_g1=K_g1,K_g2,K_g2,K_r1=K_r1,K_r2=K_r2))
    @test_throws AssertionError construct_vertex(WindTurbineGenType4(T_L=T_L,T_H=T_H,K_P=k_P_invalid,ΔP_max=ΔP_max,K_PLL=K_PLL,C=C,J=J,u_dcref=u_dcref,K_Q=K_Q,K_v=K_v,K_g1=K_g1,K_g2,K_g2,K_r1=K_r1,K_r2=K_r2))

    wind_gen = WindTurbineGenType4(T_L=T_L,T_H=T_H,K_P=K_P,ΔP_max=ΔP_max,K_PLL=K_PLL,C=C,J=J,u_dcref=u_dcref,K_Q=K_Q,K_v=K_v,K_g1=K_g1,K_g2,K_g2,K_r1=K_r1,K_r2=K_r2)
