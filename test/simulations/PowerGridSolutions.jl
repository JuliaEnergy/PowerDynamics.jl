...
@testset "PowerGridSolution should find proper variable_index" begin
        ...
        nodes_dict = Dict("bus1"=>SwingEqLVS(H=1., P=-1, D=1, Ω=50, Γ=20, V=1),"bus2"=> SwingEqLVS(H=1., P=-1, D=1, Ω=50, Γ=20, V=1))
...
@testset "PowerGridSolution index tests" begin
        ...
        lines_dict = Dict("line1"=> StaticLine(from="bus1", to="bus2", Y=-im))
