...
node_list=[]
    ...
    append!(node_list, [SwingEqLVS(H=2, P=-1., D=0.1, Ω=50,Γ=0.1,V=1.)])
    ...
    append!(node_list, [WindTurbineGenType4_RotorControl(T_L=1,K_dbr=1,T_H=5.5,K_ω=10,K_PPLL=1000,K_IPLL=10070,Q_ref=0,C=1,J=4,P=1,ω_rref=1,u_dcref=1,K_Q=0.1,K_v=40,K_pv=10,K_iv=10,K_ptrq=3,K_itrq=0.6)])
