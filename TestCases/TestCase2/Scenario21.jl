...
node_list=[]
    ...
    append!(node_list,[GridFormingTecnalia_modifiedLowPass(ω_r=0,τ_U=τ_U, τ_I=τ_I, τ_P=τ_P, τ_Q=τ_Q, n_P=n_P, n_Q=n_Q, K_P=K_P, K_Q=K_Q, P=P, Q=Q, V_r=V_r, R_f=R_f, X_f=X_f)])
