...
simulate(np::AbstractPerturbation, op::State, timespan) = simulate(np, op.grid, op.vec, timespan; solve_kwargs...)
simulate(np::AbstractPerturbation, powergrid::PowerGrid,op::State, timespan) = simulate(np, powergrid, op.vec, timespan; solve_kwargs...)
