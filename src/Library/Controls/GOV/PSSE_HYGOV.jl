...
This model is a port of the OpenIPSL [`Electrical.Controls.PSSE.TG.HYGOV`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Electrical/Controls/PSSE/TG/HYGOV.mo) model,
...
[`Tests.Controls.PSSE.TG.HYGOV`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Tests/Controls/PSSE/TG/HYGOV.mo).
See [validation plot](../assets/OpenIPSL_valid/Htion.png) generated by automatic validation script in `/test/OpenIPSL_test`.
"""
