...
This model is a port of the OpenIPSL [`Electrical.Controls.PSSE.TG.GGOV1`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Electrical/Controls/PSSE/TG/GGOV1.mo) model,
maintaining the same mathematical formulation while adapting to PowerDynamics/ModelingToolkit conventions.

# Validation

!!! warning
    This model does not support delay! It is validaded against a modified version of the OpenIPSL SMIB testcase [`Tests.Controls.PSSE.TG.GGOV1`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Tests/Controls/PSSE/TG/GGOV1.mo) without delay (see reference data generation script in `/test/OpenIPSL/GGOV1` for modified version). Also, the OpenIPSL testcase does not start in a steady state, so we have some deviation in the validation still.
        See [validation plot](../assets/OpenIPSL_valid/GGOV1.png) generated by automatic validation script in `/test/OpenIPSL_test`.
"""
