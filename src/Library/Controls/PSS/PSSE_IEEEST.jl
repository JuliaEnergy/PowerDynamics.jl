...
This model is a port of the OpenIPSL [`Electrical.Controls.PSSE.PSS.IEEEST`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Electrical/Controls/PSSE/PSS/IEEEST.mo) model,
...
[`Tests.Controls.PSSE.PSS.IEEEST`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Tests/Controls/PSSE/PSS/IEEEST.mo).
See [validation plot](../assets/OpenIPSL_valid/IEEEST.png) generated by automatic validation script in `/test/OpenIPSL_test`.
"""
