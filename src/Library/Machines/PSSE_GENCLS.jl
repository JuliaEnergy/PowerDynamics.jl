...
This model is a port of the OpenIPSL [`Electrical.Machines.PSSE.GENCLS`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Electrical/Machines/PSSE/GENCLS.mo) model,
...
[`Tests.Machines.PSSE.GENCLS`](https://github.com/OpenIPSL/OpenIPSL/blob/fe8aa5c/OpenIPSL/Tests/Machines/PSSE/GENCLS.mo).
See [validation plot](../assets/OpenIPSL_valid/GENCLS.png) generated by automatic validation script in `/test/OpenIPSL_test`.
"""
