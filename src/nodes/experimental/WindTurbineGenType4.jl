...
@DynamicNode WindTurbineGenType4(D,K_PLL,Q_ref,C,J,P,ω_rref,u_dcref,K_Q,K_v,K_g1,K_g2,K_r1,K_r2) begin
    ...
    @assert C>=0
    @assert K_PLL>=0
end [[θ_PLL,dθ_PLL],[e_IP,de_IP],[e_IV,de_IV],[u_dc,du_dc],[ω_r,dω_r]] begin#,[i_q,di_q],[u_tref,du_tref]] begin
    ...
    #de_Idθ_PLL,dθ_LL=PI_control(e_Idθ_PLL,v_q,K_PLL,K_PLL)#v_q*K_PLL
