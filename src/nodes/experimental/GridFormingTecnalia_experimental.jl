@DynamicNode GridFormingTecnalia_experimental(ω_r,τ_U, τ_I, τ_P, τ_Q, n_P, n_Q, K_P, K_Q, P, Q, V_r, R_f, X_f) begin
    ...
    @assert R_f >= 0
    @assert X_f >= 0
end [[u_fil_r,du_fil_r],[u_fil_i,du_fil_i],[i_fil_r,di_fil_r],[i_fil_i,di_fil_i],[ω, dω],[v,dv]] begin
    ...
    #du = u - v + R_f*(i - i_fil) + 1im*X_f*i_fil
    u_out = v + R_f*(i - i_fil) + 1im*X_f*i_fil
    du = u - u_out
end

export GridFormingTecnalia_experimental
